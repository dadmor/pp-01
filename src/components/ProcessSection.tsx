      ...
      <section id="process" className="py-24 bg-cream">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            {/* Timeline line */}
            <div className="absolute left-1/2 transform -translate-x-1/2 w-0.5 h-full bg-therapy-200 hidden lg:block"></div>
              ...
              {steps.map((step, index) => (
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div className="w-14 h-14 bg-therapy-700 text-white rounded-full flex items-center justify-center font-bold text-xl shadow-lg hover:scale-110 transition-transform duration-300">
                      {step.number}
                    </div>
                  </div>
